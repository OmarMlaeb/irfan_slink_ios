...
/// Description:
/// English bubble drawed using UIBeazierPath.
class EnglishBubbleView: UIView {
    
    var fillColor = UIColor(red: 0.826, green: 0.860, blue: 0.205, alpha: 0.200)
    var isToggle = false
