...
- (void)initialize
{
    ...
    [collectionView registerClass:[FSCalendarHeaderCell class] forCellWithReuseIdentifier:@"FSCalendarCell"];
...
{
    FSCalendarHeaderCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"FSCalendarCell" forIndexPath:indexPath];
    cell.header = self;
