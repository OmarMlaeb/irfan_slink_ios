...
class AudioReceivedTableViewCell: UITableViewCell, AVAudioPlayerDelegate {
    ...
    @IBAction func playButtonTapped(_ sender: UIButton) {
        ...
        if audioPlayer?.isPlaying == true {
            ...
            AudioReceivedPlaybackManager.shared.currentPlayingCell = nil
...
//            audioPlayer?.play()
            AudioReceivedPlaybackManager.shared.playAudio(for: self)
